...
def update_file_descriptions(
    ...
    def create_file_descriptions(programming_language, json_file):
        ...
        file_descriptions = {
            ...
            "external": "External data sources or files obtained from third parties.",
            "proprietary": "Data with legal, licensing, NDA, or IP restrictions.",
            "sensitive": "Data with privacy or confidentiality constraints (for example PII).",
            ...
            "LICENSE.txt": "Project license file covering code, documentation, and default data licensing (dataset-specific terms are in project root dmp.json).",
